...
/**
 * Source plugin for YouTube videos connected to the Story content type.
 * See: https://healthsciences.arizona.edu/admin/structure/types/manage/newsstory
 * 
 * @MigrateSource(id = "newsstory_youtube_video_id")
 */
class NewsStoryYouTubeVideoID extends SqlBase {
